...
//   return (
//     <div className="p-6 rounded-2xl shadow-lg bg-white flex flex-col w-[400px]">
...
//       </div>
//       <p className="text-gray-700 text-sm mt-3 truncate">
//         {mentor.about} <span className="text-blue-500 cursor-pointer">Read More</span>
//       </p>
//       <div className="mt-4">
//         <h3 className="font-semibold text-black">What I Offer!</h3>
//         <ul className="text-sm text-gray-600 space-y-2 mt-2">
//           <li className="flex items-center gap-2">
//             <FaVideo className="text-blue-500" /> Audio/Video Sessions
//           </li>
//           <li className="flex items-center gap-2">
//             <FaBullseye className="text-green-500" /> Goal Setting
//           </li>
//           <li className="text-blue-500 cursor-pointer">+2 More</li>
//         </ul>
//       </div>
...
//           <br />
//           <span className="text-xs">Starts @ ₹499</span>
//         </button>
//       </div>
//     </div>
//   );
...
// const MentorList = () => {
//   return (
//     <div className="grid grid-cols-2 gap-6 px-6 items-center">
