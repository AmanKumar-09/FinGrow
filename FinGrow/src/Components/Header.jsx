...
//   return (
//     <div 
//       className={`flex justify-between pb-5 shadow-md items-center transition-all duration-300 ${
//         isScrolled 
...
const Header = ({ toggleProfile, isProfileOpen }) => {
  ...
  return (
    <div 
      className={`flex justify-between shadow-sm items-center transition-all duration-300 ${
        isScrolled 
          ? "fixed top-0 left-0 right-0 z-50 bg-white pb-2" 
          : "pb-5"
      }`}
    >
      <div>
